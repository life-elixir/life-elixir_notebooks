...
For more information, including technical advice, please see [Contributing to QuTiP development](https://github.com/qutip/qutip-doc/blob/master/qutip_dev_contrib.md).These files are [IPython notebooks](http://ipython.org/notebook.html) for
